...
import "./chunk-WCPF4XUU.js";
import "./chunk-FJZAFISN.js";
import "./chunk-7JKY5F5I.js";
import "./chunk-ID4OUPWN.js";
import "./chunk-ZHGIVIVE.js";
import "./chunk-QS4BN62S.js";
import {
  require_react
...
function CreateNewIncomingReference(t0) {
  ...
  bb0: {
    if (!creationAllowed) {
      let t33;
      $[9] === Symbol.for("react.memo_cache_sentinel") ? (t33 = [], $[9] = t33) : t33 = $[9], t2 = t33;
      break bb0;
    }
    let t32;
    if ($[10] !== creationAllowed || $[11] !== initialValueTemplateItems || $[12] !== type) {
      ...
      $[14] !== creationAllowed || $[15] !== type ? (t42 = (i) => {
        var _a;
        const typeMatch = type === ((_a = i.template) == null ? void 0 : _a.schemaType);
...
function _temp$2(item) {
  var _a, _b, _c;
  return ((_a = item.template) == null ? void 0 : _a.schemaType) ? {
    id: item.id,
    title: item.title || `${item.template.schemaType} from template ${(_b = item.template) == null ? void 0 : _b.id}`,
    i18n: item.i18n,
    type: item.template.schemaType,
    icon: item.icon,
    template: {
      id: (_c = item.template) == null ? void 0 : _c.id,
...
function LinkToExistingPreview(props) {
  ...
  let t1;
  $[4] === Symbol.for("react.memo_cache_sentinel") ? (t1 = {
    snapshot: null,
    isLoading: true,
    original: null
  }, $[4] = t1) : t1 = $[4];
  ...
  if ($[5] !== releases || $[6] !== t || $[7] !== value._id) {
    bb0: {
      ...
      if (isDraftId(id)) {
        let t32;
        $[9] === Symbol.for("react.memo_cache_sentinel") ? (t32 = getReleaseTone("drafts"), $[9] = t32) : t32 = $[9];
        let t42;
      ...
      if (isPublishedId(id)) {
        let t32;
        $[14] === Symbol.for("react.memo_cache_sentinel") ? (t32 = getReleaseTone("published"), $[14] = t32) : t32 = $[14];
        let t42;
...
function AddIncomingReference(t0) {
  ...
  let t10;
  $[24] === Symbol.for("react.memo_cache_sentinel") ? (t10 = {
...
function IncomingReferencesType(t0) {
  const $ = (0, import_compiler_runtime.c)(69), {
    ...
    getClient
  } = useSource(), displayedId = displayed == null ? void 0 : displayed._id;
  let t1;
  ...
  let t3;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => {
    setIsAdding(_temp);
  }, $[10] = t3) : t3 = $[10];
  const handleAdd = t3, publishedExists = !!(editState == null ? void 0 : editState.published);
  let t4;
  $[11] === Symbol.for("react.memo_cache_sentinel") ? (t4 = async (documentId) => {
    setIsAdding(false), setNewReferenceId(documentId);
  }, $[11] = t4) : t4 = $[11];
  const handleCreateNewReference = t4;
  let t5;
  $[12] !== client || $[13] !== onLinkDocument || $[14] !== publishedExists || $[15] !== referenced.id || $[16] !== referenced.type || $[17] !== (schemaType == null ? void 0 : schemaType.liveEdit) || $[18] !== toast ? (t5 = async (documentId_0) => {
    setIsAdding(false), setNewReferenceId(documentId_0);
    const liveEdit = !!(schemaType == null ? void 0 : schemaType.liveEdit), document = await client.fetch("*[_id == $id][0]", {
      id: documentId_0
    }), linkedDocument = onLinkDocument == null ? void 0 : onLinkDocument(document, {
      _type: "reference",
  ...
  }, $[12] = client, $[13] = onLinkDocument, $[14] = publishedExists, $[15] = referenced.id, $[16] = referenced.type, $[17] = schemaType == null ? void 0 : schemaType.liveEdit, $[18] = toast, $[19] = t5) : t5 = $[19];
  ...
  let t9;
  $[31] !== (schemaType == null ? void 0 : schemaType.title) || $[32] !== shouldRenderTitle || $[33] !== type.title ? (t9 = shouldRenderTitle && (0, import_jsx_runtime.jsx)(Box, { paddingY: 2, paddingX: 0, children: (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: type.title || (schemaType == null ? void 0 : schemaType.title) }) }), $[31] = schemaType == null ? void 0 : schemaType.title, $[32] = shouldRenderTitle, $[33] = type.title, $[34] = t9) : t9 = $[34];
  let t10;
  $[35] !== documents || $[36] !== isAdding || $[37] !== newReferenceId || $[38] !== renderItem || $[39] !== (schemaType == null ? void 0 : schemaType.title) || $[40] !== t || $[41] !== type.title ? (t10 = documents.length > 0 ? (0, import_jsx_runtime.jsx)(IncomingReferencesListContainer, { $itemCount: documents.length, children: (0, import_jsx_runtime.jsx)(CommandList, { activeItemDataAttr: "data-hovered", ariaLabel: t("incoming-references-input.list-label", {
    type: type.title || (schemaType == null ? void 0 : schemaType.title)
  }), canReceiveFocus: true, fixedHeight: true, getItemKey: (index) => documents[index]._id, itemHeight: INCOMING_REFERENCES_ITEM_HEIGHT, items: documents, onlyShowSelectionWhenActive: true, overscan: 5, renderItem, wrapAround: false }) }) : (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "center", padding: 2, hidden: isAdding || !!newReferenceId, children: (0, import_jsx_runtime.jsx)(Text, { size: 1, muted: true, children: t("incoming-references-input.no-items") }) }) }), $[35] = documents, $[36] = isAdding, $[37] = newReferenceId, $[38] = renderItem, $[39] = schemaType == null ? void 0 : schemaType.title, $[40] = t, $[41] = type.title, $[42] = t10) : t10 = $[42];
  let t11;
...
function IncomingReferencesList(t0) {
  ...
  if (!types || (types == null ? void 0 : types.length) === 0) {
    let t12;
